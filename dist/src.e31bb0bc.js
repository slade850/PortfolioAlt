...
/*#__PURE__*/
function () {
  function Input(id, type, placeholder, parent, req) {
...
/*#__PURE__*/
function () {
  function FormElement(title, id, action, parent, input) {
    var _this = this;
    ...
    this.allInput = input;
    this.variables = [];
    this.nodeParent = document.querySelector("#".concat(parent));
    this.nodeElement = document.createElement('form');
    this.nodeElement.id = this.id;
    this.nodeElement.innerHTML = "<h2>".concat(this.title, "</h2>");
    this.allInput.forEach(function (el) {
      _this.variables.push(el.id);

      var i = _this.variables.indexOf(el.id);

      _this.variables[i] = new Input(el.id, el.type, el.id, _this.nodeElement, el.req);
    });
    this.init();
  ...
  _createClass(FormElement, [{
    ...
    value: function handleSubmit(event) {
      ...
      var body = {};
      this.variables.forEach(function (el) {
        body[el.id] = el.value;
      });
...
var NewLoginForm = new FormElement('Login', 'loginForm', 'http://localhost:3000/api/user/authenticate', 'app', [{
  id: 'namefield',
  type: 'text',
  req: true
}, {
...
NewLoginForm;
var NewRegisterForm = new FormElement('Register', 'registerForm', 'http://localhost:3000/api/user/register', 'app', [{
  id: 'username',
  type: 'text',
  req: true
}, {
